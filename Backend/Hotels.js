...
export function multiStepForm1_wixFormSubmitted(fields) {
	...
	let goingToQuery = fields.fields[0].fieldValue;
	let departingDate =JSON.stringify(fields.fields[1].fieldValue);
	let returningDate = JSON.stringify(fields.fields[2].fieldValue);
	...
	console.log("Finding Hotels in " + goingToQuery + " on " + departingDate + " and checking out on " + returningDate )
}
